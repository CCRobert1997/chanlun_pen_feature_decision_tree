...
if __name__ == "__main__":
    ...
    return_test_timestamps = return_test_generate_timestamps("2024-12-15 17:19:07", "2025-05-05 15:10:07", 10)
        ...
        # if is_market_open(): # 线上实盘用
            ...
            for GROUP_SIZE_index, GROUP_SIZE in enumerate(GROUP_SIZEs):
                ...
                if GROUP_SIZE_index == 0:
                    print(["+" if clean_zhongshu["direction"] == "Up" else "-" for clean_zhongshu in pen_zhongshus_clean])
