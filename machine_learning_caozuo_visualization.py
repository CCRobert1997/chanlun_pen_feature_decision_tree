...
data_folder = "machine_learning_caozuo"
plot_folder = "machine_learning_plot"
valid_prefixes = [
...
app = Flask(__name__, static_folder="machine_learning_plot")
...
def load_data():
    ...
    for prefix in valid_prefixes:
        ...
        for interval in time_intervals:
            file_name = f"{prefix}_{interval}_machine_learning_caozuo.csv"
...
@app.route('/machine_learning_plot/<path:filename>')
