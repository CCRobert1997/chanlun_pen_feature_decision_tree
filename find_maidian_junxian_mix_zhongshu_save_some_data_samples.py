...
if __name__ == "__main__":
    ...
    return_test_timestamps = return_test_generate_timestamps("2024-12-15 17:19:07", "2025-04-05 15:10:07", 10)
    return_test_timestamps = return_test_generate_timestamps("2024-12-15 17:19:07", "2025-01-05 15:10:07", 10)
    ...
    ############################### 单次测试用 ###############################
        ...
        # if is_market_open(): # 线上实盘用
            ...
            for GROUP_SIZE_index, GROUP_SIZE in enumerate(GROUP_SIZEs):
                ...
                changjunxian_window = 20  # 156#200#250#1250#250
